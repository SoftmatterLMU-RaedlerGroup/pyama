...
class ProcessingController(QObject):
    ...
    def start_workflow(self) -> None:
        ...
        self._update_state(is_processing=True, status_message="Running workflow…", error_message="")
    ...
    def _validate_ready(self) -> None:
        ...
        if (
            self._state.channels.phase is None
            and not self._state.channels.fluorescence
        ):
